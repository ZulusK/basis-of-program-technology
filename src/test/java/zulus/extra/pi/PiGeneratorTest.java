...
public class PiGeneratorTest {
    ...
    public void MaxValuetPowerModTest() {
        ...
        answer = powerModTester(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
        assertEquals(answer, PiGenerator.powerMod(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE));
    }
